...
// ❌ SAYA HAPUS DARI SINI (Agar tamu tidak bisa masuk)
...
Route::middleware(['auth'])->group(function () {
    ...
    // ✅ SAYA PINDAHKAN KE SINI (Aman, Wajib Login)
    Route::get('/cart', [CartController::class, 'index'])->name('cart.index');
