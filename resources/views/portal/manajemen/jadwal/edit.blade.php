<x-portal-layout portalName="Manajemen Kebun" pageTitle="Edit Jadwal" :menuItems="$menuItems">
<div class="max-w-2xl">
    <div class="mb-5 flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-extrabold text-slate-800">Edit Jadwal Kebun</h2>
            <p class="text-xs text-slate-500">Perbarui rincian aktivitas dan jadwal operasional kebun</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 sm:p-8">
        <form action="{{ route('portal.manajemen.jadwal.update', $jadwal) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <x-custom-dropdown 
                    ...
                    :options="$lahanList" 
                    :value="old('lahan_id', $jadwal->lahan_id)" 
                    searchable 
                />
            </div>
            ...
            <div>
                ...
                <input type="text" name="jenis_aktivitas" value="{{ old('jenis_aktivitas', $jadwal->jenis_aktivitas) }}" required 
                       ...
                       placeholder="Contoh: Pembersihan gulma, Perbaikan irigasi, Pemupukan">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="tanggal" value="{{ old('tanggal', $jadwal->tanggal ? $jadwal->tanggal->format('Y-m-d') : '') }}" required 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 outline-none text-sm font-semibold text-slate-800">
                ...
                <div>
                    ...
                    <x-custom-dropdown 
                        ...
                        :options="[
                            'pending' => 'Pending (Belum Terlaksana)',
                            'selesai' => 'Selesai',
                            'batal' => 'Batal'
                        ]" 
                        required 
            ...
            <div>
                ...
                <textarea name="catatan" rows="3" 
                          ...
                          placeholder="Catatan kebutuhan tenaga kerja, peralatan, dll...">{{ old('catatan', $jadwal->catatan) }}</textarea>
            </div>
