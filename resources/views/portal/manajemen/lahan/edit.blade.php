<x-portal-layout portalName="Manajemen Kebun" pageTitle="Edit Lahan" :menuItems="$menuItems">
<div class="max-w-2xl">
    <div class="mb-5 flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-extrabold text-slate-800">Edit Data Lahan</h2>
            <p class="text-xs text-slate-500">Perbarui informasi blok lahan kebun durian Anda</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 sm:p-8">
        <form action="{{ route('portal.manajemen.lahan.update', $lahan) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="nama_lahan" value="{{ old('nama_lahan', $lahan->nama_lahan) }}" required 
                       ...
                       placeholder="Contoh: Blok A - Bukit Sentosa">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="luas_ha" value="{{ old('luas_ha', $lahan->luas_ha) }}" step="0.01" min="0" required 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 outline-none text-sm font-semibold text-slate-800">
                ...
                <div>
                    ...
                    <x-custom-dropdown 
                        name="kondisi" 
                        :value="old('kondisi', $lahan->kondisi)" 
                        :options="[
                            'baik' => 'Baik',
                            'sedang' => 'Sedang',
                            'buruk' => 'Buruk'
                ...
                <div>
                    ...
                    <input type="number" name="jumlah_pohon" value="{{ old('jumlah_pohon', $lahan->jumlah_pohon) }}" min="0" 
                           class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 outline-none text-sm font-semibold text-slate-800">
            ...
            <div>
                <label class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">Lokasi / Keterangan Letak</label>
                <input type="text" name="lokasi" value="{{ old('lokasi', $lahan->lokasi) }}" 
                       ...
                       placeholder="Contoh: Sisi timur kebun dekat sumber mata air">
            </div>
            ...
            <div>
                ...
                <textarea name="catatan" rows="3" 
                          ...
                          placeholder="Catatan topografi, jenis tanah, dll...">{{ old('catatan', $lahan->catatan) }}</textarea>
            </div>
