<x-portal-layout portalName="Pembibitan" pageTitle="Buat Jadwal" :menuItems="$menuItems">
<div class="max-w-2xl">
    <div class="mb-5 flex items-center gap-3">
        <a href="{{ route('portal.pembibitan.jadwal.index') }}" 
        ...
        <div>
            <h2 class="text-xl font-extrabold text-slate-800">Buat Jadwal Perawatan</h2>
            <p class="text-xs text-slate-500">Agendakan jadwal perawatan rutin bibit di persemaian</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm p-6 sm:p-8">
        <form action="{{ route('portal.pembibitan.jadwal.store') }}" method="POST" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="jenis_perawatan" value="{{ old('jenis_perawatan') }}" required 
                       ...
                       placeholder="Contoh: Penyiraman Pagi, Pemupukan Daun, Pindah Polybag">
            ...
            <div>
                ...
                <textarea name="catatan" rows="3" 
                          ...
                          placeholder="Dosis nutrisi, instruksi khusus...">{{ old('catatan') }}</textarea>
            </div>
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('portal.pembibitan.jadwal.index') }}" class="px-5 py-3 bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold rounded-xl transition-colors">
                    Batal
                </a>
            </div>
        </form>
