...
<head>
    ...
    <title>Kode Reset Kata Sandi AgriSmart</title>
    <style type="text/css">
        /* Reset Styles */
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding-bottom: 20px;">
            ...
            <p style="font-size: 15px; color: #475569; margin-bottom: 20px;">
                Kami menerima permintaan untuk mereset kata sandi akun AgriSmart Anda. Berikut adalah kode verifikasi OTP Anda:
            </p>
            ...
            <p style="font-size: 14px; color: #64748b; margin-top: 10px;">
                Jika Anda tidak merasa meminta reset kata sandi, mohon abaikan email ini. Akun Anda tetap aman.
            </p>
        </div>
