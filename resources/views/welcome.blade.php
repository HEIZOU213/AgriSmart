        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden lg:flex items-center gap-2">
                    <a href="#" class="px-5 py-2.5 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Beranda</a>
                    ...
                    <a href="#" class="px-5 py-2.5 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Tentang</a>
                    <a href="#" class="px-5 py-2.5 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Kontak</a>
                </div>
                    ...
                    @auth
                        ...
                        <div class="hidden md:block relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                {{-- Ganti baris 65-70 dengan kode ini --}}
...
@endif
                    ...
                    @else
                        ...
                        <a href="{{ route('register') }}" class="hidden md:inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-xl hover:shadow-lg hover:scale-105 transition-all">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:hidden hidden bg-white border-t border-gray-200" id="mobileMenu">
            <div class="px-4 py-4 space-y-2">
                <a href="#" class="block px-4 py-3 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Beranda</a>
                ...
                <a href="#" class="block px-4 py-3 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Tentang</a>
                <a href="#" class="block px-4 py-3 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">Kontak</a>
                ...
                <div class="pt-4 border-t border-gray-200 space-y-2">
                    @auth
                        ...
                        <a href="{{ route('konsumen.pesanan.index') }}" class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:text-green-600 font-semibold rounded-xl hover:bg-green-50 transition-all">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                            </svg>
                            Pesanan Saya
    ...
    {{-- Education Section dengan Masonry Layout --}}
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-3xl mb-16">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    Akses konten terpilih dari para ahli pertanian dan tetap update dengan teknik bertani terkini.
                </p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($edukasi as $index => $item)
                        <a href="{{ route('edukasi.show', $item->slug) }}" 
                           class="group block {{ $index === 0 ? 'md:col-span-2 md:row-span-2' : '' }}">
                            <div class="relative h-full bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                                ...
                                <div class="relative h-full min-h-[300px] {{ $index === 0 ? 'md:min-h-[600px]' : '' }}">
                                    ...
                                    <div class="absolute inset-0 p-8 flex flex-col justify-end">
                                        <div class="space-y-4">
                                            <div class="flex items-center gap-3">
                                                <span class="px-4 py-1.5 bg-green-500 text-white text-xs font-bold uppercase tracking-wide rounded-full">
                                                    Edukasi
                                                </span>
                                                <span class="text-gray-300 text-sm">{{ $item->created_at->format('d M Y') }}</span>
                                            </div>
                                            
                                            <h3 class="text-2xl {{ $index === 0 ? 'lg:text-4xl' : '' }} font-bold text-white leading-tight group-hover:text-green-400 transition-colors">
                                                {{ $item->judul }}
                                            </h3>
    ...
    {{-- Products Section dengan Bento Grid --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <p class="text-xl text-gray-600">
                    Produk berkualitas premium dengan harga terbaik, langsung dari petani lokal
                </p>
            </div>
                        ...
                        <div class="group relative">
                            <div class="relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100">
                                ...
                                <div class="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                                    ...
                                    @else
                                        <div class="w-full h-full bg-gradient-to-br from-green-200 to-emerald-300 flex items-center justify-center">
                                            <svg class="w-24 h-24 text-green-600 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6">
                                        <a href="{{ route('produk.show', $item->id) }}" 
                                           class="w-full py-3 bg-white text-green-700 font-bold text-center rounded-2xl transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                            Lihat Cepat
                                        </a>
                                    </div>
                                    ...
                                    <div class="absolute top-4 left-4 right-4 flex justify-between items-start">
                                        <span class="px-4 py-2 bg-green-500 text-white text-xs font-black uppercase rounded-full shadow-xl backdrop-blur-sm">
                                            Segar
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 space-y-4">
                                    <div>
                                        <span class="inline-block px-3 py-1 bg-gray-100 text-gray-700 text-xs font-bold rounded-lg mb-3">
                                            {{ $item->kategoriProduk->nama_kategori }}
                                        </span>
                                        <h3 class="text-lg font-bold text-gray-900 leading-snug line-clamp-2 min-h-[3.5rem]">
                                            {{ $item->nama_produk }}
                                        </h3>
                                    </div>
                                    ...
                                    <div class="flex items-end justify-between pt-2 border-t border-gray-100">
                                        ...
                                        <a href="{{ route('produk.show', $item->id) }}" 
                                           class="w-12 h-12 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-2xl flex items-center justify-center hover:shadow-lg hover:scale-110 transition-all duration-300">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- CTA Section dengan Parallax Effect --}}
        ...
        <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="space-y-8">
                ...
                <h2 class="text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight">
                    Siap Mentransformasi<br/>Bisnis Pertanian Anda?
                </h2>
                
                <p class="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto font-light">
                    Bergabunglah dengan ribuan petani yang telah merangkul pertanian digital
                </p>
                ...
                {{-- Trust Indicators --}}
                <div class="flex items-center justify-center gap-8 pt-12 flex-wrap">
