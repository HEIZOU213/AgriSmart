            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="isi_konten" id="isi_konten" rows="10" 
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('isi_konten', $konten->isi_konten) }}</textarea>
                </div>
                <div>
                ...
                {{-- [BARU] Tampilkan foto saat ini --}}
                <div>
                    <label class="block text-sm font-medium text-gray-700">Foto Sampul Saat Ini</label>
                    @if($konten->foto_sampul)
                        <img src="{{ asset('storage/' . $konten->foto_sampul) }}" alt="{{ $konten->judul }}" class="w-32 h-32 object-cover rounded mt-2 shadow">
                    @else
                        <p class="mt-2 text-sm text-gray-500">Tidak ada foto sampul.</p>
                    @endif
                </div>

                {{-- [BARU] Field ganti foto --}}
                <div>
                    <label for="foto_sampul" class="block text-sm font-medium text-gray-700">Ganti Foto Sampul (Opsional)</label>
