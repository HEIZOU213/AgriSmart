<x-admin-layout>
    ...
    <div class="text-gray-900">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {{-- KOLOM KIRI: STATUS DAN AKSI KONFIRMASI (ADMIN) --}}
                ...
                <div class="bg-white shadow sm:rounded-lg p-6 border border-gray-200">
                    ...
                    <form action="{{ route('admin.pesanan.update', $pesanan->id) }}" method="POST">
                        ...
                        <select name="status" id="status" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            {{-- [KODE FINAL]: ADMIN HANYA MENGELOLA FULFILLMENT (PENGIRIMAN/SELESAI/BATAL) --}}
                            ...
                            {{-- Kita hapus Pending dan Paid dari daftar opsi --}}
                        </select>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($pesanan->detailPesanan as $detail)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">{{ $detail->produk->user->nama }}</td>
