<x-admin-layout>
    ...
    <div class="space-y-8 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group bg-white rounded-3xl p-6 shadow-lg shadow-green-900/5 border border-white hover:border-green-200 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="px-2 py-1 bg-green-50 text-green-600 rounded-lg text-xs font-bold">Pembeli</span>
                    </div>
            ...
            <div class="group bg-white rounded-3xl p-6 shadow-lg shadow-green-900/5 border border-white hover:border-green-200 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-4">
                        ...
                        <span class="px-2 py-1 bg-green-50 text-green-600 rounded-lg text-xs font-bold">Literasi</span>
                    </div>
    ...
    <div class="p-6 bg-white rounded-2xl border border-slate-200 shadow-sm flex items-center justify-between">
        <div>
            <h3 class="text-sm text-slate-500 font-medium uppercase tracking-wider">Keuntungan AgriSmart</h3>
            <p class="text-3xl text-slate-900 font-black mt-1">
                Rp {{ number_format($stats['pendapatan_bersih'], 0, ',', '.') }}
            </p>
            <p class="text-xs mt-2 text-slate-400">Total dari 06% komisi transaksi sukses</p>
        </div>
